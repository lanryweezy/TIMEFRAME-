    ...
    <div className="py-32 max-w-5xl mx-auto px-6">
      ...
      >
        <div className="glass p-10 rounded-3xl flex flex-col justify-center">
          <h2 className="text-sm font-semibold text-electric-blue uppercase tracking-widest mb-4">
            The New Paradigm
          </h2>
          <h3 className="text-5xl font-extrabold tracking-tighter mb-6 text-white">
            Timelines Are A Legacy Format.
          </h3>
          <p className="text-studio-text text-lg leading-relaxed mb-6">
            For three decades, creators have been trapped in rigid linear timelines. While tools
            evolved, the workflow stagnated. We are drowning in manual labor while AI waits to be
            unleashed.
          </p>
          <p className="text-studio-text text-lg leading-relaxed">
            Timeframe isn't an editor. It's a creative operating system. By fusing intelligent
            agents with generative power, we turn creation from a manual slog into a directed
            symphony.
          </p>
        </div>
        <motion.div
        ...
        >
          ...
          <p className="text-2xl italic text-white/90 relative z-10">
            "The bottleneck isn't the skill, it's the tools. We are moving from 'doing' to
            'directing'."
          </p>
