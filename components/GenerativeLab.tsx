...
import { Sparkles, Zap, Brain, Wand2, Film, Layers, Cpu, Database, TrendingUp, Search, Info } from 'lucide-react';
...
export const GenerativeLab: React.FC<GenerativeLabProps> = ({
  state,
  onSendMessage,
}) => {
  return (
    <div className="w-full h-full flex flex-col bg-[#050505] overflow-y-auto custom-scrollbar">
      ...
      <div className="px-12 py-12 flex flex-col gap-2 border-b border-white/5 bg-gradient-to-r from-studio-accent/5 via-transparent to-transparent">
        ...
        <p className="text-zinc-500 text-xs font-medium tracking-wide max-w-xl">
            Orchestrate neural networks to synthesize high-fidelity media assets. 
            All generated content is automatically optimized for your current project resolution.
        </p>
      </div>
                ...
                {GENERATIVE_TOOLS.map((tool) => (
                    ...
                    >
                        ...
                        <div className="space-y-1">
                            <h3 className="text-sm font-black text-white uppercase tracking-tight">{tool.name}</h3>
                            <p className="text-[10px] text-zinc-500 font-medium leading-relaxed">{tool.description}</p>
                        </div>
                        <div className="mt-2 flex items-center justify-between">
                            <span className="text-[9px] font-black text-zinc-600 uppercase tracking-widest">v4.0 Alpha</span>
        ...
        <div className="xl:col-span-4 space-y-8">
            <div className="p-8 rounded-3xl bg-zinc-900/20 border border-white/5 space-y-6">
                ...
                <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="flex gap-4 items-start p-3 hover:bg-white/2 rounded-xl transition-colors cursor-pointer group">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-[10px] font-bold text-zinc-300 truncate">Cinematic_Shot_{i}.mp4</p>
            ...
            <div className="p-8 rounded-3xl bg-studio-accent/5 border border-studio-accent/10 space-y-4">
                ...
                <p className="text-[10px] text-zinc-400 leading-relaxed">
                    The engine is currently attuned to your project's <span className="text-studio-accent">"Cinematic Cyberpunk"</span> style profile. 
                    All generations will inherit these aesthetic weights.
                </p>
            </div>
        </div>
      </div>
